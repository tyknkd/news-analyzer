...
| C     | Production environment        | [deployment](https://github.com/tyknkd/news-analyzer/tree/main/deployment)                                                                                                                                                                                                                                                                                                                                                                                           |
...
| B     | Monitoring                    | [monitoring](https://github.com/tyknkd/news-analyzer/tree/main/monitoring)                                                                                                                                                                                                                                                                                                                                                                                           |
...
| A     | Continuous delivery           | [.github/workflows](https://github.com/tyknkd/news-analyzer/tree/main/.github/workflows)                                                                                                                                                                                                                                                                                                                                                                             | 

## Live Production Deployment
The app is deployed on [Google Kubernetes Engine](https://cloud.google.com/kubernetes-engine) and can be accessed at [www.jeitikei.online/](http://www.jeitikei.online/)

## REST API
The REST API entry point is [www.jeitikei.online/api](http://www.jeitikei.online/). [HATEOAS](https://en.wikipedia.org/wiki/HATEOAS) principles are applied in order to facilitate hypermedia-driven 
